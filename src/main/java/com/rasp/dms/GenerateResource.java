...
public class GenerateResource {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String controller_dir = "src/main/java/com/rasp/dms/controller";
        String controller_package = "com.rasp.dms.controller";
        if (args.length > 0) {
        ...
        ResourceGenerator generator = new ResourceGenerator("com.rasp.dms", "src/main/java/com/rasp/dms/");
        ...
        generator.generateCode("src/main/java/com/rasp/dms/", null);
